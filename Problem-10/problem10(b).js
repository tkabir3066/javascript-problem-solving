...
console.log(matchHouses(0)); //Step 0 returns 0 matchsticks
console.log(matchHouses("4")); //The input (step) will always be a non-negative integer
console.log(matchHouses("key")); //The input (step) will always be a non-negative integer
